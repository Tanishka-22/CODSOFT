...
# picture
rock_img = ImageTk.PhotoImage(Image.open("Rock-Paper-Scissor Game\\images\\rock-user.png"))
paper_img = ImageTk.PhotoImage(Image.open("Rock-Paper-Scissor Game\\images\\paper-user.png"))
scissor_img = ImageTk.PhotoImage(Image.open("Rock-Paper-Scissor Game\\images\\scissors-user.png"))
rock_img_comp = ImageTk.PhotoImage(Image.open("Rock-Paper-Scissor Game\\images\\rock.png"))
paper_img_comp = ImageTk.PhotoImage(Image.open("Rock-Paper-Scissor Game\\images\\paper.png"))
scissor_img_comp = ImageTk.PhotoImage(Image.open("Rock-Paper-Scissor Game\\images\\scissors.png"))
